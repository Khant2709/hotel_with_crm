        ...
        <>
            ...
            <section className={`${stylesFonts.newRoman400} ${classes.main}`}>
                ...
                <p className={classes.text}>
                    ...
                    безопасности персональных данных, предпринимаемые Агросток (далее —
                    Оператор).
                </p>
                ...
                <ul className={classes.list}>
                    ...
                    <li>
                        ...
                        Оператора resortegorova@gmail.com с пометкой «Актуализация
                        персональных данных».
                    </li>
                    <li>
                        ...
                        resortegorova@gmail.com с пометкой «Отзыв согласия на обработку
                        персональных данных».
                    </li>
                    <li>
                ...
                <ul className={classes.list}>
                    <li>
                        ...
                        к Оператору с помощью электронной почты Khant2709@gmail.com.
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        сети Интернет по адресу https://sanmarinosochi.ru/privacy.
                    </li>
                </ul>
                ...
                <h2 className={classes.subtitle}>1. Общие положения:</h2>
                <p className={classes.text}>
                    На этой странице мы четко определяем условия использования контента,
                    представленного на нашем сайте. Мы стремимся защитить наши авторские
                    права и обеспечить честное и согласованное использование материалов.
                    Прочитав нашу политику использования контента, вы соглашаетесь с
                    следующими условиями:
                </p>
                <ul className={classes.list}>
                    <li>
                        1.1. Авторские права: Весь контент на данном сайте является объектом
                        авторских прав и принадлежит ИП Егоров Егор Викторович. Перед
                        использованием или распространением любого материала с нашего сайта,
                        необходимо получить письменное разрешение.
                    </li>
                    <li>
                        1.2. Личное использование: Посетители могут свободно просматривать,
                        загружать и распечатывать материалы с нашего сайта для личного,
                        некоммерческого использования.
                    </li>
                    <li>
                        1.3. Несанкционированное использование: Любое несанкционированное
                        копирование, воспроизведение, распространение или изменение нашего
                        контента считается нарушением авторских прав.
                    </li>
                    <li>
                        1.4. Связь с нами: Если у вас есть вопросы относительно
                        использования нашего контента или если вам необходимо разрешение на
                        его использование, пожалуйста, свяжитесь с нами через электронную
                        почту resortegorova@gmail.com.
                    </li>
                </ul>
            </section>
        </>
