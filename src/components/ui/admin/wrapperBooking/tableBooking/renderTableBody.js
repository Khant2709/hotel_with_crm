...
export const renderTableBody = ({bookings, hotels, apartments, openBooking, format = 'desktop', isSettingPage}) => {
...
const DesktopBookingRow = ({
    ...
    <tr>
      {!isSettingPage && <td onClick={() => openBooking(booking.id)}>
        <div
