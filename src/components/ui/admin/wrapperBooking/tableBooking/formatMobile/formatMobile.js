 ...
 */
const FormatMobile = ({bookings, hotels, apartments, openBooking}) => {
        ...
        <div className={styles.containerCards}>
            {
                bookings.map((booking) => {
                    ...
                    return <div key={`mobile_${booking.id}`}
                        ...
                        <button className={`${stylesFontT.newRoman400} ${styles.btn}`}
